...
import { Storage, StorageReference, UploadResult, getDownloadURL, ref, uploadBytes, uploadBytesResumable } from '@angular/fire/storage';
...
export class StorageInDialogEditProfileImgService {
